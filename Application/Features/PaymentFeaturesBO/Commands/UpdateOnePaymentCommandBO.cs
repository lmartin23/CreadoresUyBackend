...
{
    public class UpdateOnePaymentCommandBO : IRequest<Response<string>>
    {
        ...
        public class UpdateOnePaymentCommandBOBOHandler : IRequestHandler<UpdateOnePaymentCommandBO, Response<string>>
        {
            private readonly ICreadoresUyDbContext _context;
            private readonly ImagePostService _imagePost;

            public UpdateOnePaymentCommandBOBOHandler(ICreadoresUyDbContext context, ImagePostService imagePost)
            {
                _context = context;
                _imagePost = imagePost;
            }
            public async Task<Response<string>> Handle(UpdateOnePaymentCommandBO command, CancellationToken cancellationToken)
            {
